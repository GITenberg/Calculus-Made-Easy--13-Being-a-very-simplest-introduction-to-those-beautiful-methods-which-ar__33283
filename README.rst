...
This is a git repository of the source files for the book Calculus Made Easy&#13;Being a very-simplest introduction to those beautiful methods which are generally called by the terrifying names of the Differential Calculus and the Integral Calculus by Being a very-simplest introduction to those beautiful methods which are generally called by the terrifying names of the Differential Calculus and the Integral Calculus Thompson, Silvanus P. (Silvanus Phillips). This book is in the Public Domain, see the LICENSE file for details.
